...
class ViewNotificationsController extends LaDanseController
{
	/**
     * @Route("/notifications", name="viewNotifications")
     * @Template("LaDanseSiteBundle:settings:viewNotifications.html.twig")
     */
